# Reference Page : https://github.com/hhl60492/SOMPY_robust_clustering/tree/master/sompy/visualization
...
class HitMapView(MatplotView):
    ...
    def show(self, som, data=None):
        ...
        # img_hitmap = plt.imshow(codebook.reshape(msz[0], msz[1])[::], alpha=.5)
        # plt.show()
        # plt.imsave('hitmap.jpg', img_hitmap)
